...
// Configuration
const REPO_OWNER = process.env.FLEXBUFFERS_REPO_OWNER || 'paranoikcodit';
...
async function main() {
  ...
  try {
    ...
    try {
      ...
      console.error('   4. Report issues at: https://github.com/paranoikcodit/flexbuffers-js/issues');
      process.exit(1);
    }
  }
}
